...
public interface CustomizableMessages {
    ...
    String CUSTOMIZABLE_NAME_SIZE = "Customizable name cannot be longer than 200 characters";

    int CUSTOMIZABLE_CATEGORY_MAX = 20;
    String CUSTOMIZABLE_CATEGORY_NULL = "Customizable category (string) cannot be null or empty";
    String CUSTOMIZABLE_CATEGORY_SIZE = "Customizable category cannot be longer than 20 characters";
    
    int CUSTOMIZABLE_TYPE_MAX = 20;
    String CUSTOMIZABLE_TYPE_NULL = "Customizable type (string) cannot be null or empty";
    String CUSTOMIZABLE_TYPE_SIZE = "Customizable type cannot be longer than 20 characters";
    ...
    String CUSTOMIZABLE_IMG_SIZE = "Customizable name url cannot be longer than 150 characters";
