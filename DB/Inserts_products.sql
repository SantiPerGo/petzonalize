...
CUIDAD SENCILLA: La cama gato desenfundable se puede lavar a máquina en agua fría, circulación suave, lavada por separado, secada y planchada a baja temperatura, no limpie en seco. " ,  " /assets/img/products/not customizable/cat-supplies-bedsure-big-bed.png " ,  " Bedsure Cama Gato Grande Estampada - Camas para Gatos Suave y Lavable, Cojin Pequeño Interior y Redondo " ,  521.61 ,  16 ,  " cat ");

INSERT INTO products(category, customizable, description, imgUrl, name, price, stock, type)
value(" health " ,  false ,  " Sistema Inmunológico y Salud ósea: Este poderoso suplemento es para apoyar a gatos de 4 meses o más. Soporte Inmunológico para Gatos: Los nutrientes apoyan el sistema inmunológico y la energía, perfecto para gatos activos.
...
Excelente Solución de Cuidado: PetAg ofrece productos de alta calidad para dueños y profesionales de animales. " ,  " /assets/img/products/not customizable/cat-health-petag-supplement-gel.png " ,  " Suplemento en gel de vitaminas y minerales PetAg - Soporte inmunitario para gatos -Contiene vitamina D y Zinc " ,  335 ,  12 ,  " cat ");
